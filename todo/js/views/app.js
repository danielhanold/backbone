...
app.AppView = Backbone.View.extend({
  ...
  // Delegated events for creating items, and clearing completed ones.
  events: {
  ...
  // Trigger the 'visible' event on a Todo.
  filterOne: function(todo) {
    todo.trigger('visible');
  },

  // Trigger the 'visible' event for all Todos.
  filterAll: function() {
  ...
  // When hitting return in the main input field, create a new Todo model
  // and have it persist in the local storage.
